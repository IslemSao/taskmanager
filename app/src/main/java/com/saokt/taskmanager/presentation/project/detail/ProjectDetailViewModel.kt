...
class ProjectDetailViewModel @Inject constructor(
    ...
    fun initializeNewProject() {
        ...
        val owner = ProjectMember(
            ...
            role = com.saokt.taskmanager.domain.model.ProjectRole.OWNER
        )
            ...
            try {
                ...
                projectFlow.collect { project ->
                    ...
                    if (project != null) {
                        ...
                        Log.d("ProjectMembersDebug", "ProjectDetailViewModel: Project not found")
                    }
                }
            } catch (e: Exception) {
                Log.e("ProjectMembersDebug", "ProjectDetailViewModel: Error loading project", e)
                _state.update {
                    it.copy(
                        isLoading = false,
